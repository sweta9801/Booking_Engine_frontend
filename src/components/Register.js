        ...
        return (
            <div className="form">
                ...
                <div className="form-group">
                    <label>
                        Email:
                        <input type="text" name="email" value={this.state.credentials.email} onChange={this.inputChanged}></input>
                    </label>
                </div>
                <br></br>
                ...
                <p>If you have already an account? <Link to='/login'>Log In</Link></p>
                </div>
            </div>
        );
    }
